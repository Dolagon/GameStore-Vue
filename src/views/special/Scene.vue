<template>
  <div id="main">
    ...
    <div v-if="showLoading" style="height: 100%;">
      <van-nav-bar style="box-shadow: #cacaca 0 0 5px;" :fixed=true title="剧情精选" left-arrow @click-left="backHome"></van-nav-bar>
      <!-- 商品 -->
      <div ref="container" class="container">
        <img id="banner" src="https://media.st.dl.pinyuncloud.com/steam/apps/391540/header.jpg?t=1579096091">
...
export default {
  ...
  methods: {
    ...
    async getProductLength() {
      let res = await getProductByType(5);
