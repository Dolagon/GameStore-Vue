<template>
  <div class="container">
    ...
    <el-form :model="numberValidateForm" ref="numberValidateForm" label-width="100px" class="demo-ruleForm">
      <el-form-item label="图片名称" prop="image_title" :rules="[{ required: false, message: '名称不能为空'}]">
        <el-input type="image_title" v-model="numberValidateForm.image_title" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="图片地址" prop="image_url" :rules="[{ required: false, message: '地址不能为空'}]">
      ...
      <el-form-item label="跳转链接" prop="image_link" :rules="[{ required: false, message: '跳转链接不能为空'}]">
        <el-input type="image_link" v-model="numberValidateForm.image_link" autocomplete="off"></el-input>
      </el-form-item>


      <el-form-item style="cursor: pointer" label="上架时间" prop="s_time" :rules="[{ required: false, message: '下架时间不能为空'}]">
        <el-col :span="11">
          <el-date-picker type="date" placeholder="选择日期" v-model="numberValidateForm.s_time" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
      <el-form-item style="cursor: pointer" label="下架时间" prop="e_time" :rules="[{ required: false, message: '下架时间名称不能为空'}]">
        <el-col :span="11">
...
export default {
  ...
  methods: {
    ...
    async submitForm(formName) {
      if (this.numberValidateForm.user_name === '' || this.numberValidateForm.user_pwd === '') {
